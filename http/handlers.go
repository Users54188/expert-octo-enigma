...
func handleIndicators(w http.ResponseWriter, r *http.Request) {
    ...
    if err := json.NewEncoder(w).Encode(response); err != nil {
        log.Printf("Failed to encode indicators response: %v", err)
    }
}
...
func handleKLines(w http.ResponseWriter, r *http.Request) {
    ...
    w.Header().Set("Content-Type", "application/json")
    if err := json.NewEncoder(w).Encode(response); err != nil {
        log.Printf("Failed to encode klines response: %v", err)
    }
}
...
func handleBatchAnalysis(w http.ResponseWriter, r *http.Request) {
    ...
    if err := json.NewEncoder(w).Encode(results); err != nil {
        log.Printf("Failed to encode batch analysis response: %v", err)
    }
}
...
func handlePredict(w http.ResponseWriter, r *http.Request) {
    ...
    w.Header().Set("Content-Type", "application/json")
    if err := json.NewEncoder(w).Encode(response); err != nil {
        log.Printf("Failed to encode predict response: %v", err)
    }
}
